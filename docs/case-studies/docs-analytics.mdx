...
threads, bounce rate. Signals exist, but nobody reads them in a structured way, so "what should the docs fix next?" gets answered
...
flowchart TD
    ...
    T --> R[Sprint review: shipped, ignored, why]
...
**3. A fixed cadence.** A short review every sprint: what changed in the
...
[How this site works](/docs/meta/this-site).
</Callout>
